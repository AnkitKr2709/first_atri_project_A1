...
class Atri:
	...
	@property
	def Flerrot(self):
		self._getter_access_tracker["Flerrot"] = {}
		return self._Flerrot
	@Flerrot.setter
	def Flerrot(self, new_state):
		self._setter_access_tracker["Flerrot"] = {}
		global default_state
		self._Flerrot = Flex(new_state, default_state["Flerrot"])
