...
export function useFlerrotCb() {
	const onClick = useCallback(callbackFactory("Flerrot", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useButton33Cb() {
	const onClick = useCallback(callbackFactory("Button33", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
